describe Fastlane::Actions::SendEMailAction do
  ...
  describe '#send_e_mail' do
      params = { "stmpserver" => "smtp.yeah.net", "userName" => "xyhuangjia@yeah.net", "password" => "HJ123456", "recipients" => ["2587171762@qq.com", "1593033769@qq.com"], "subject" => "测试标题", "message_body" => "测试文本" }
